...
import Course from "app/models/identity/profile/course";

export default class CourseView extends Model {
  static schema = {
    /**
     * @property profileId
    ...
    /**
     * @property elements
     * Ordered array of courses.
     */
    elements: Course,

    modelType: "identity/profile/course-view"
  }
}
